...
export default class LibraryDetailInstallationBlock extends React.Component {
  ...
  generatePIOProjectConf() {
    ...
    let content = `# innaterapluginio.ini – project configuration file
    ...
    return (
      <div>
        <h2 style={{ marginTop: 0 }}>
          Library Dependencies <small>innaterapluginio.ini</small>
        </h2>
        <div className="block">
          <p>
            ...
            library dependencies in &quot;innaterapluginio.ini&quot; configuration file using{' '}
            <a
              onClick={() =>
