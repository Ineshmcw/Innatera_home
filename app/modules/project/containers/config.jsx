...
class ProjectConfig extends React.PureComponent {
  ...
  handleOpen = () => {
    this.props.openTextDocument(
      pathlib.join(this.props.project.path, 'innaterapluginio.ini')
    );
  };
      ...
      <Menu onClick={this.handleNewSectionMenuClick}>
        {!this.sectionExists(SECTION_GLOBAL_ENV) && (
          <Menu.Item
            ...
            title="Common configuration for all environments. Saved as [env] section in the `innaterapluginio.ini` file"
          >
        ...
        {!this.sectionExists(SECTION_PLATFORMIO) && (
          <Menu.Item
            ...
            title="Saved as [platformio] section in the innaterapluginio.ini file"
          >
            PlatformIO Settings
          </Menu.Item>
        )}
